...
namespace MechanicsDesign
{
  public class CSimulationManager
  {
    ...
    public CPlayerFdApp federate; //Application-specific federate 
        ...
        public bool IsBattleLogOn = false;
    ...
    private void initialize()
    {
      switch (federate.RTILibrary)
      {
        case RTILibraryType.HLA13_DMSO: case RTILibraryType.HLA13_Portico: case RTILibraryType.HLA13_OpenRti:
                ...
                federate.FederationExecution.FDD = @"C:\Users\ahmed\source\repos\PlayerFdApp\MechanicsFOM.fed";
        break;
        case RTILibraryType.HLA1516e_Portico: case RTILibraryType.HLA1516e_OpenRti:
                ...
                federate.FederationExecution.FDD = @"C:\Users\ahmed\source\repos\PlayerFdApp\MechanicsFOM.xml";
        break;
      }
    }
    #endregion //Methods
